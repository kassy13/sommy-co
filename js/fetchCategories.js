...
// Purpose:
// The startCountdown function creates a countdown timer that updates every second until a specified end date is reached. It calculates the remaining time and displays it in a days, hours, minutes, and seconds format.
...
function startCountdown(endDate) {
  ...
  const interval = setInterval(function () {
    ...
    //   the interval  Sets a timer that runs a function every 1000 milliseconds (1 second).
    // The interval keeps updating the countdown display in real-time.

    // now: Gets the current time in milliseconds since January 1, 1970 (UNIX timestamp).
    // distance: The difference (in milliseconds) between the current time and the endDate. This represents the remaining time.
...
// 72 * 60 * 60 * 1000: Adds 72 hours to the current time.
// Why?
// 60 * 60 * 1000: Converts 1 hour into milliseconds (3600000ms).
// 72 * 3600000: Converts 72 hours into milliseconds (259200000ms).
// Adding this to the current time sets the end date to 72 hours from now.
